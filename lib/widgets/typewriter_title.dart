...
class _TypewriterTitleState extends State<TypewriterTitle>
  ...
  String _displayText = '';
  int _currentPhase = 0; // 0: typing kali.nyc, 1: backspacing, 2: typing software engineer, 3: backspacing
  int _currentIndex = 0;
  
  final List<String> _texts = ['kali.nyc', 'software engineer'];
  final int _typingSpeed = 100; // milliseconds
  final int _backspaceSpeed = 80; // milliseconds
